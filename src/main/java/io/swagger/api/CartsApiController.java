...
public class CartsApiController implements CartsApi {
    ...
    public ResponseEntity<List<Cart>> getAllTransaction() {
        ...
        if (accept != null && accept.contains("application/xml")) {
            try {
                return new ResponseEntity<List<Cart>>(objectMapper.readValue("<Cart>  <cartId>123456789</cartId>  <dishId>123</dishId>  <dishQuatity>123</dishQuatity>  <orderMasterId>123</orderMasterId></Cart>", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
