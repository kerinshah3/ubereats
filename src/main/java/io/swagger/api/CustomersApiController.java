...
public class CustomersApiController implements CustomersApi {
    ...
    public ResponseEntity<List<Customer>> getAllCustomers() {
        ...
        if (accept != null && accept.contains("application/xml")) {
            try {
                return new ResponseEntity<List<Customer>>(objectMapper.readValue("<Customer>  <id>123456789</id>  <name>aeiou</name>  <email>aeiou</email>  <password>aeiou</password></Customer>", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
